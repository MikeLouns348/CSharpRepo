...
public class EnemyShipMovementRight : MonoBehaviour {

	
	//controls movement for enemy ships that begin by moving to the right
	...
	//creates the illusion of old school space invaders where they tick over instead of smooth transition between points. 
